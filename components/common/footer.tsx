    ...
    return (
        <footer className="bg-[#050510] border-t border-white/[0.05] pt-16 pb-12 px-4 font-sans relative z-10">
            <div className="max-w-7xl mx-auto flex flex-col items-center">
                {/* Branding/Copyright */}
                <p className="text-[11px] font-black text-white/80 uppercase tracking-[0.25em] mb-4 text-center">
                    &copy; 2026 Hysync Network. All Rights Reserved.
                </p>
                ...
                <div className="flex flex-col md:flex-row items-center gap-4 md:gap-12">
                    <a
                        ...
                        className="text-[10px] font-black text-white/80 hover:text-white transition-colors uppercase tracking-[0.15em] border-b border-white/5 hover:border-white/20 pb-1"
                    >
